    ...
    with torch.no_grad():
        ...
        for _ in tqdm(range(total_frames), desc="[processing video and saving/view result videos]"):
            if success:
                ...
                compare_image = transforms.Resize((sr_video_size[1], sr_video_size[0]), interpolation=Mode.BICUBIC)(raw_frame)
                ...
                bottom_image = np.asarray(transforms.Resize((bottom_image_height, bottom_image_width))(transforms.ToPILImage()(bottom_image)))
