...
class DiscriminatorForVGG(nn.Module):
    def __init__(self, image_size: int) -> None:
        ...
        self.features = nn.Sequential(
            nn.Conv2d(3, 64, 3, 1, 1),  # input is (3) x 256 x 256
            nn.LeakyReLU(0.2, True),

            nn.Conv2d(64, 64, 3, 2, 1, bias=False),  # state size. (64) x 128 x 128
            nn.BatchNorm2d(64),
            nn.LeakyReLU(0.2, True),
            ...
            nn.Conv2d(128, 128, 3, 2, 1, bias=False),  # state size. (128) x 64 x 64
            nn.BatchNorm2d(128),
            nn.LeakyReLU(0.2, True),
            ...
            nn.Conv2d(256, 256, 3, 2, 1, bias=False),  # state size. (256) x 32 x 32
            nn.BatchNorm2d(256),
            nn.LeakyReLU(0.2, True),
